...
CONFIRM_PORT = int(os.environ.get("CONFIRM_PORT", "7000"))
...
def run_confirm_server() -> None:
    print(f"Confirmation server listening on http://{BIND_HOST}:{CONFIRM_PORT} (human-facing)")
    HTTPServer((BIND_HOST, CONFIRM_PORT), ConfirmHandler).serve_forever()
